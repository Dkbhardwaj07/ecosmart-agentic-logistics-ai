...
class ExecutiveAIService:
    ...
    def generate_advisory(self, result_data):
        ...
        advisory = f"""
                ...
                Generated by Autonomous Executive Intelligence Layer

                (Nova Bedrock integration active — fallback mode engaged due to quota limits)

                Route: {result_data['optimized_route']}

                Operational Assessment:
                Performance index is {performance} with {risk} operational risk profile.

                Sustainability Assessment:
                {sustainability_msg}

                Strategic Recommendation:
                This route is suitable for enterprise deployment with balanced cost and environmental impact.

                Executive Decision Guidance:
                {decision_msg}

                AI System Status:
                • Nova Bedrock Integration: Active
                • Executive Intelligence Layer: Operational
                • Autonomous Decision Engine: Enabled
